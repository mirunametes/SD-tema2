...
public class SmartDeviceUserViewDTO implements SmartDeviceViewDTO{
    ...
    public SmartDeviceUserViewDTO(String description, String address, float maxEnergyConsumtion, float avgConsumtion, String sensorDescription, String userName) {
    ...
    public void setSensorDescription(String sensorName) {
        this.sensorDescription = sensorName;
    }
